...
<body>
    <main id="main">
        ...
        <form action="./config/logIn_config.php" method="POST">
            ...
            <input type="text" class="form-control" name="correo" id="correo" placeholder="correo@gmail.com" aria-label="Username" aria-describedby="basic-addon1" required pattern=".+\@.+\..+">
            </div>
            ...
            <div class="d-grid gap-2 col-6 mx-auto">
             ...
             <p><a href="./logOn.php">¿Ya tienes una cuenta?</a></p>
            </div>
        </form>
    </main>
